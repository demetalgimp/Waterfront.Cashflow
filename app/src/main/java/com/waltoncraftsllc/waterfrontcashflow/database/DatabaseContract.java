...
//--- Category-labels table [works & integrated]------------------------------------------------------------------------------------------------------
    ...
    public static final String CATEGORIES__ID = "Category_ID";
        public static final String CATEGORIES__ID_TYPE = " integer primary key";
    public static final String CATEGORIES__NAME = "Name";
        public static final String CATEGORIES__NAME_TYPE = " text not null unique on conflict replace";
...
//--- Tender-labels table [works & integrated]--------------------------------------------------------------------------------------------------------
    ...
    public static final String LEGAL_TENDER_LABELS__ID = "Tender_ID";
        public static final String LEGAL_TENDER_LABELS__ID_TYPE = " integer primary key";
    public static final String LEGAL_TENDER_LABELS__NAME = "Label";
        public static final String LEGAL_TENDER_LABELS__NAME_TYPE = " text not null unique on conflict replace";
...
//--- Periodicity-labels table [works & integrated]---------------------------------------------------------------------------------------------------
    ...
    public static final String PERIODICITY_LABELS__ID = "Periodicity_ID";
        public static final String DEFAULT_PERIODICITY_LABELS__ID_TYPE = " integer primary key";
