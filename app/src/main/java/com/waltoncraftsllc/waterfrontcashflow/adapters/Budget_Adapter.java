...
//    private BudgetTree tree;
    ...
    private void setupTestData() {
        ...
        mBudgets.add(new Budget("./Consumables/Non-Food", new ArrayList<>(Collections.singletonList(
                new Budget_TimeBracket("2025-01-01", "2025-12-31", new Money("45"), "Weekly (52/yr)")))));
        ...
        mBudgets.add(new Budget("./Provisions/Education", new ArrayList<>(Collections.singletonList(
                new Budget_TimeBracket("2025-01-01", "2025-12-31", new Money("20"), "Monthly (12/yr)")))));
        mBudgets.add(new Budget("./Provisions/Mad money", new ArrayList<>(Collections.singletonList(
                new Budget_TimeBracket("2025-01-01", "2025-12-31", new Money("50"), "Weekly (52/yr)")))));
        ...
        mBudgets.add(new Budget("./Provisions/Personal Gifts/Other", new ArrayList<>(Collections.singletonList(
                new Budget_TimeBracket("2025-01-01", "2025-12-31", new Money("200"), "Annually (1/yr)")))));
        mBudgets.add(new Budget("./Subscription Services/Entertainment", new ArrayList<>(Collections.singletonList(
                new Budget_TimeBracket("2025-01-01", "2025-12-31", new Money("3"), "Weekly (52/yr)")))));
